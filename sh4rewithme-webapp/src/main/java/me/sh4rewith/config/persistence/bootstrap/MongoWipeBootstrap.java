...
public class MongoWipeBootstrap {
	...
	public MongoWipeBootstrap bootstrap() {
		mongo.dropCollection(RawFileInfoMapper.RAW_FILE_INFO_COLLECTION);
		mongo.dropCollection(RawFileMapper.RAW_FILE_COLLECTION);
		mongo.dropCollection(SharedFileInfoMapper.SHARED_FILE_INFO_COLLECTION);
		mongo.dropCollection(SharedFileFootprintMapper.SHARED_FILE_FOOTPRINT_COLLECTION);
		mongo.dropCollection(UserInfoMapper.USER_INFO_COLLECTION);
